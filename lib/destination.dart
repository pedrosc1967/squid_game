...
import 'package:squid_game/tts_helper.dart';
// import 'facebook_code.dart';
import 'package:share/share.dart';
import 'package:easy_localization/easy_localization.dart';
import 'package:squid_game/utils/responsive.dart';
import 'package:squid_game/constants.dart';
...
class Destination extends StatefulWidget {
  ...
  Destination({this.entry, this.definition, this.resource});
...
class DestinationState extends State<Destination> {
  ...
  void initState() {
    /*
    *  Facebook Ads TODO change it AdMob mediation to include FB and AdMob ads
    *
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  fontSize:
                      responsive.hp(Constants.heigthPercentFontSize * 1.2),
                ),
              ),
            ),
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  speak(widget.entry + widget.definition);
      ...
      // bottomNavigationBar: bannerAd,  <-- Ad comes here
    );
  }
}
