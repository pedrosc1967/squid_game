...
import 'package:squid_game/alphabetical_screen.dart';
...
//    FirebaseAnalyticsObserver(analytics: analytics);
  ...
  Widget build(BuildContext context) {
    ...
    return new SplashScreen(
      seconds: 14,
      navigateAfterSeconds: new Responsive(context),
      title: new Text(
        'Welcome In SplashScreen',
        style: new TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0),
      ),
      image: new Image.asset('Squid_Game.jpg'),
...
class HomePageState extends State<HomePage> with WidgetsBindingObserver {
  ...
  RateMyApp rateMyApp = RateMyApp(
    ...
    appStoreIdentifier: '1545741185', //TODO needs update here
...
// reference to a function as well:....
    ...
    switch (defaultLocale) {
      case 'en':
        {
          dataFilename = 'assets/data-us.json';
        }
        break;
